	...
	<body>
		...
		<div class="container">
			<div class="row"><!--first row-->
				<div class="col-md-3">
					<img src="http://loremflickr.com/220/220/dog" class="img-responsive center-block" alt="dog" />
				</div><!--column-->
			...
			<div class="row"><!--second row-->
				<div class="col-md-3">
					<img src="http://loremflickr.com/220/220/flower" class="img-responsive img-circle center-block" alt="flower"/>
				...
				<div class="col-md-3">
					<img src="http://loremflickr.com/220/220/duck" class="img-responsive img-circle center-block" alt="duck"/>
				...
				<div class="col-md-3">
					<img src="http://loremflickr.com/220/220/rain" class="img-responsive img-circle center-block" alt="river"/>
				...
				<div class="col-md-3">
					<img src="http://loremflickr.com/220/220/puppy" class="img-responsive img-circle center-block" alt="puppy"/>
